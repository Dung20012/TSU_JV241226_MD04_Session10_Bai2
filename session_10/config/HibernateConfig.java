...
public class HibernateConfig {
    ...
    public SessionFactory sessionFactory() {
        ...
        sessionBuilder.scanPackages("com.data.session_10.model.entity"); // package containing your entity classes
    ...
    public DataSource dataSource() {
        ...
        dataSource.setUrl("jdbc:mysql://localhost:3306/session_10");// replace with your database URL
